...
function getHighestPopCountry(countriesData) {
  /* let highestPop = 0
  let highestPopCountry = ""

  for (let i = 0; i < countriesData.length; i++) {
    if (countriesData[i].population > highestPop) {
      highestPop = countriesData[i].population
      highestPopCountry = countriesData[i].name.common
    }
  } */

  let highestPopCountry = countriesData[0]

  for (let i = 1; i < countriesData.length; i++) {
    if (highestPopCountry.population < countriesData[i].population) {
      highestPopCountry = countriesData[i]
    }
  }

  return highestPopCountry.name.common
}

//console.log(getHighestPopCountry(countries))

function getHighestPopCountries(countriesData, n) {
  ...
  for (let i = 0; i < n; i++) {
    result.push({
      name: sortedCountries[i].name.common,
...
function countryWithMostOfficialLanguages(countriesData, n) {
  const filteredCountries = countriesData.filter((country) => country.languages)

  const sortedCountries = [...filteredCountries].sort((a, b) => Object.keys(b.languages).length - Object.keys(a.languages).length)
  ...
  for (let i = 0; i < n; i++) {
    result.push({
      name: sortedCountries[i].name.common,
      languages: sortedCountries[i].languages
    })
  }
...
console.log(getHighestPopCountries(countries, 3))
console.log(countryWithMostOfficialLanguages(countries, 10))
